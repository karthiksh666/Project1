...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        userObject = userLoggedInService.getLoggedInUser();
        return testRequestQueryService.findByTester(userObject);
    ...
    public void setTestRequestUpdateService(TestRequestUpdateService testRequestUpdateService) {
        this.testRequestUpdateService = testRequestUpdateService;
    }

    public void setTestRequestQueryService(TestRequestQueryService testRequestQueryService) {
        this.testRequestQueryService = testRequestQueryService;
    }

    public TestRequestFlowService getTestRequestFlowService() {
        return testRequestFlowService;
    }

    public void setTestRequestFlowService(TestRequestFlowService testRequestFlowService) {
        this.testRequestFlowService = testRequestFlowService;
    }

    public void setUserLoggedInService(UserLoggedInService userLoggedInService) {
